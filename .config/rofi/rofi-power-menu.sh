...
actions[switchuser]="dm-tool switch-to-greeter || gdmflexiserver"
    ...
    do
        ...
        then
            ...
            then
                ...
                # Jos valinta on logout, reboot tai shutdown, tapetaan portaalit ensin tässä
                if [[ "$entry" == "logout" || "$entry" == "reboot" || "$entry" == "shutdown" ]]; then
